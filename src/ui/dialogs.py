...
class GenerationParamsDialog(QDialog):
    ...
    def __init__(self, parent: QWidget | None = None):
        ...
        self.thinking_prefill_enabled_checkbox = QCheckBox("思考の書き出しを入れる")
        ...
        self.thinking_prefill_text_edit.setPlaceholderText("思考の書き出しに使う文")
        ...
        prefill_thinking_layout.addWidget(QLabel("思考の書き出し:"))
        ...
        prefill_thinking_layout.addWidget(QLabel("思考の書き出し形式:"))
